  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        unselectedItemColor: Color.fromARGB(255, 46, 46, 46), // สีเมื่อไม่ถูกเลือก
        onTap: _onItemTapped,
      ),
    );
  }
